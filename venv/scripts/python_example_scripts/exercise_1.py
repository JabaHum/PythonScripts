...
print("Exercise Print List of numbers in range of 1500 and 2700 ")

for i in range(1500, 2700):
    # numbers are divisible by 7 if they don't have any remainder
    if i % 7 == 0 and i % 5 == 0:
        print(i, end=",")
# numbers divisible by 7 and a multiple of 5
